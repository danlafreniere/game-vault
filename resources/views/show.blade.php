  ...
  <div class="game-details border-b border-gray-800 pb-8 flex flex-col lg:flex-row">
    ...
    <div class="lg:ml-12 lg:mr-48 xl:mr-64">
      ...
      <div class="mt-12">
        ...
        <a href="{{ $game['trailer'] }}" target="_blank" class="inline-flex gap-2 bg-blue-500 text-white font-semibod px-4 py-3 hover:bg-blue-600 rounded transition ease-in-out duration-150">
          <svg class="w-6 fill-current" viewBox="0 0 24 24">
            <path d="M0 0h24v24H0z" fill="none"></path>
            <path d="M10 16.5l6-4.5-6-4.5v9zM12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm0 18c-4.41 0-8-3.59-8-8s3.59-8 8-8 8 3.59 8 8-3.59 8-8 8z"></path>
          </svg>
