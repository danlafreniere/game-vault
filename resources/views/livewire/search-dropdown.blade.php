<div class="relative" x-data="{ isVisible: true }" @click.away="isVisible = false">
  <input wire:model.debounce.300ms.live="search"
      type="text" class="bg-gray-800 text-sm rounded-full w-64 px-3 py-1 focus:outline-none focus:ring pl-8"
      placeholder="Search..."
  ...
  <svg wire:loading aria-hidden="true" class="absolute top-[6px] right-2 w-4 h-4 text-gray-200 animate-spin dark:text-gray-600 fill-white" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <ul>
      ...
      <li class="border-b border-gray-700">
        <a href="{{ route('games.show', $game['slug']) }}"
            class="hover:bg-gray-700 p-3 flex items-center transition ease-in-out duration-150"
